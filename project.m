...
function process_audio(filename, figure_num)
    % Read in audio file
    [y, Fs] = audioread(filename);
    
    % Print out original sampling rate
    fprintf('Original Sampling Rate: %u \n', Fs);
...
% Process one file
process_audio("Input_mp3/Conversation low voice street.mp3", 1);